...
@section('content')
  ...
  <div class="section no-pad-bot" id="index-banner">
    ...
    <div class="schabloneAnzeigen">
      ...
      <br><br>
            <span class="schabloneSpan"><img class="img.schabloneImage" src="bilder/schablone.png" alt="Schablone zur Anforderungsformulierung"/><br></span>
...
<br>
   ...
   <label type="text">
     ...
     <label type="text">
      ...
      <div class="row center-right">
        <input value="Speichern" type="submit" id="eingabe-button" class="btn-large waves-effect right htwg-darkblue" style="height: 50px; width: 180px;"></a>
      </div>
