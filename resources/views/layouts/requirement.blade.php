    ...
    <tr>
        <td>
            <p> Bitte bewerten Sie die Anforderungen</p>
                <input type="radio" name="{{ $requirement->id }}[func_answer]" value="entzueckt" id="helpful" required> Das würde mir sehr helfen </input><br/>
                <input type="radio" name="{{ $requirement->id }}[func_answer]" value="wird erwartet" id="basic" required> Das ist eine grundlegende Anforderung für mich </input><br/>
                <input type="radio" name="{{ $requirement->id }}[func_answer]" value="gleichgueltig" id="irrelevant" required> Das würde mich nicht betreffen </input><br/>
                <input type="radio" name="{{ $requirement->id }}[func_answer]" value="stoert" id="annoying" required> Das wäre eine geringe Unannehmlichkeit für mich </input><br/>
                <input type="radio" name="{{ $requirement->id }}[func_answer]" value="frustriert" id="problematic" required> Das wäre ein großes Problem für mich </input><br/>
        </td>
        <td>
            <p> Wie wichtig ist diese Anforderung für Sie?</p>
            <input type="radio" name="{{ $requirement->id }}[imp_answer]" value="extrem wichtig" id="extremely_important" required> Überaus wichtig </input><br/>
...
<table id="radioTable">
    <tr>
        <td>
            <p> Bitte bewerten Sie die Anforderungen</p>
                <input type="radio" name="{{ $requirement->id }}[dys_answer]" value="entzueckt" id="helpful" required> Das würde mir sehr helfen </input><br/>
